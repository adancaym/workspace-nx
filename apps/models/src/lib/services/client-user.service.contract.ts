import { ICreateClientUser, IReadClientUser, IUpdateClientUser } from "../models";
import { IServiceContract } from "../core/service.contract";

export interface ClientUserServiceContract extends IServiceContract<ICreateClientUser, IUpdateClientUser, IReadClientUser>{
